    ...
    public void updateBatteryStyle(boolean isUnknown) {
        switch (mBatteryStyle) {
            ...
            case BATTERY_STYLE_FULL_CIRCLE:
                mBatteryIconView.setImageDrawable(isUnknown ? getUnknownStateDrawable(): mFullCircleDrawable);
                mBatteryIconView.setVisibility(View.VISIBLE);
                scaleBatteryMeterViews();
                break;
            case BATTERY_STYLE_RLANDSCAPE:
                mBatteryIconView.setImageDrawable(isUnknown ? getUnknownStateDrawable(): mRLandscapeDrawable);
                mBatteryIconView.setVisibility(View.VISIBLE);
                scaleBatteryMeterViews();
            break;
            case BATTERY_STYLE_LANDSCAPE:
                mBatteryIconView.setImageDrawable(isUnknown ? getUnknownStateDrawable(): mLandscapeDrawable);
                mBatteryIconView.setVisibility(View.VISIBLE);
                scaleBatteryMeterViews();
            break;
