...
import static com.syberia.android.systemui.Dependency.*;
...
public abstract class SyberiaSystemUIModule {
    ...
    @Provides
    @SysUISingleton
    static SyberiaServices provideSyberiaServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> lazy, Lazy<ColumbusServiceWrapper> lazyB) {
